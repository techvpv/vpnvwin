...
" --log data\logfile.tmp --status data\status.dat 1 "
        ...
        ' -----------------------------------------------XXXXXXXXXXXXXXXXX-----------------------------------------------
        ' Function 'myConnection' doesn't return a value on all code paths. A null reference exception could occur at run time when the result is used.
        'Solution is to add 'Retrun False' as follow:
        'Return False
        ' -----------------------------------------------XXXXXXXXXXXXXXXXX-----------------------------------------------
